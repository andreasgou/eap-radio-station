...
public class SongTableModel extends AbstractTableModel {
    ...
    public SongTableModel(List<Song> songs) {
        ...
        if( songs != null && songs.size() > 0 ){
            for(Song song:songs){   
                this.songs1.add(new Object[]{song.getTitle(),(song.getAlbumId().getArtistId()!=null)?song.getAlbumId().getArtistId().getArtisticname():song.getAlbumId().getMusicgroupId().getName(), song.getDuration()});    
            }
        }
    }
